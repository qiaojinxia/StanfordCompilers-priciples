...
pub(crate) static NUM: &'static str = "NUM";
pub(crate) static ID: &'static str = "ID";
pub(crate) static KEYWORDS: &'static str = "KEYWORDS";
pub(crate) static LPAREN: &'static str = "LPAREN";
