...
use crate::define::{Parser, func_parser_var, func_parser_id,parser_literal, TokenType, KeyWord};
...
fn main() {
    ...
    parser.register_express(TokenType::PLUS ,func_parser_id);
    parser.register_express(TokenType::SLASH ,func_parser_id);
